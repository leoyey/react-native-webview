...
public class Web3WebViewClient extends WebViewClient {

    private final Object lock = new Object();

    private final Web3JsInjectorClient jsInjectorClient;

    private boolean isInjected;

    public Web3WebViewClient(Web3JsInjectorClient jsInjectorClient) {
    ...
    private boolean shouldOverrideUrlLoading(WebView webView, String url, boolean isMainFrame, boolean isRedirect) {
        if (jsInjectorClient == null || jsInjectorClient.getWalletAddress() == null) {
            return false;
        }
    ...
    public WebResourceResponse shouldInterceptRequest(WebView view, WebResourceRequest request) {
        ...
        Web3JsInjectorResponse response;
        try {
